...
**Status: Phase 1 — extraction core, CLI only.** No Slack, no vault writes yet.
...
| `SCRIBE_TEXT_MODEL` | `qwen3.5:4b` | Summarization (Phase 2) |
...
- **Phase 2** — summarize via one structured call, render the vault note template
